...
class Gateway extends AbstractGateway
{
    ...
    public function rebill(array $parameters = []): RebillRequest
    {
        return $this->createRequest(RebillRequest::class, $parameters);
    }

    public function cancelRebill(array $parameters = []): CancelRebillRequest
    {
        return $this->createRequest(CancelRebillRequest::class, $parameters);
    }
}
